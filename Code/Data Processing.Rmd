...
# Save to csv.
write.csv(Covid19_China, row.names = FALSE, file = "./Data/Raw/Covid19_China.csv")
```
...
# Save to csv.
write.csv(Covid19_Hubei, row.names = FALSE, file = "./Data/Raw/Covid19_Hubei.csv")
```
...
write.csv(Covid19_Global, row.names = FALSE, file = "./Data/Raw/Covid19_Global.csv")
...
# Save to csv.
write.csv(historical_China, row.names = FALSE, file = "./Data/Raw/historical_China.csv")
```
...
# Save to csv.
write.csv(historical_Global, row.names = FALSE, file = "./Data/Raw/historical_Global.csv")
```
...
# Save to csv.
write.csv(Covid19_Italy, row.names = FALSE, file = "./Data/Raw/Covid19_Italy.csv")
...
# Save to csv.
write.csv(Covid19_US, row.names = FALSE, file = "./Data/Raw/Covid19_US.csv")
...
# Save to csv.
write.csv(Covid19_UK, row.names = FALSE, file = "./Data/Raw/Covid19_UK.csv")
