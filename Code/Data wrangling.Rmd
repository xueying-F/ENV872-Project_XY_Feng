...
write.csv(Covid19_Global_processed,
          file = "./Data/Processed/Covid19_Global_processed.csv")

write.csv(Covid19_Hubei_processed,
          file = "./Data/Processed/Covid19_Hubei_processed.csv")

write.csv(Covid19_Italy_processed,
          file = "./Data/Processed/Covid19_Italy_processed.csv")

write.csv(Covid19_US_processed,
          file = "./Data/Processed/Covid19_US_processed.csv")

write.csv(Covid19_UK_processed,
          file = "./Data/Processed/Covid19_IUK_processed.csv")

write.csv(Historical_China_processed,
          file = "./Data/Processed/Historical_China_processed.csv")

write.csv(Historical_Global_processed,row.names = FALSE,
          file = "./Data/Processed/Historical_Global_processed.csv")
```
